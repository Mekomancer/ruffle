impl Twips2d {
    ...
    /// use swf::Twips2d;
    ///
    /// assert_eq!(Twips2d::new(40).saturating_sub(Twips2d::new(20)), Twips2d::new(20));
    /// assert_eq!(Twips2d::new(i32::MIN).saturating_sub(Twips2d::new(5)), Twips2d::new(i32::MIN));
    /// assert_eq!(Twips2d::new(i32::MAX).saturating_sub(Twips2d::new(-100)), Twips2d::new(i32::MAX));
    /// ```
    #[must_use]
